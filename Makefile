...
CUSTOM_BIN_PATH := ./bin
CUSTOM_EDL_PATH := ./deps/rust-sgx-sdk/edl
CUSTOM_COMMON_PATH := ./deps/rust-sgx-sdk/common
...
RustEnclave_Link_Flags := -Wl,--no-undefined -nostdlib -nodefaultlibs -nostartfiles -L$(SGX_LIBRARY_PATH) \
	...
	-Wl,--start-group -lsgx_tcxx -lsgx_tstdc -l$(DCAP_Library_Name) -l$(Service_Library_Name) -l$(Crypto_Library_Name) $(RustEnclave_Link_Libs) -Wl,--end-group \
